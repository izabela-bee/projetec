...
<main>
        ...
        <div class="fundo">
            ...
            <div class="cabecalho-fundo">
                <img class="icone-cabecalho" src="/img/fotosPerfil/perfilPadrao.png" alt="icone">
            ...
            <div class="input-container">
                <form class="form-input" method="post">
                    <label>
                        <img class="icone-file" width="20px" height="20px" src="/img/formsComponents/anexar.png" alt="icone file">
                        <input type="file" name="file">
                    </label>
                    <input type="text" name="text" placeholder="Mensagem">
                    <label>
                        <img class="icone-microfone" src="/img/formsComponents/microfone.png" alt="icone microfone">
